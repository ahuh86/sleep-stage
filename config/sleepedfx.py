# ============================================================
# config/sleepedfx.py — Sleep-EDFX 数据集训练配置
#
# 【与 sleepedf.py 的区别】
# Sleep-EDFX 是 Sleep-EDF 的扩展版本：
#   - Sleep-EDF:  20名健康受试者，20折交叉验证
#   - Sleep-EDFX: 78名受试者（包括一些有睡眠障碍的），10折交叉验证
# 更大的数据集通常能得到更好的模型。
# ============================================================
...
params = {
    ...
    'n_folds': 10,       # K折交叉验证（10折，受试者更多所以折数少一些）
    'n_subjects': 78,    # 受试者数量
